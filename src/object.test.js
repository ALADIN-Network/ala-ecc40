...
describe('Object API', () => {
  const pvt = PrivateKey('5HzzqBmg4DeneRqNRznPiBubRDGEPdcVjGZCTMGjGJWJubKm2Pe')
  ...
  describe('secp256k1 keys', () => {
    ...
    it('Helpers', () => {
      assert.equal(PrivateKey.isWif('5HzzqBmg4DeneRqNRznPiBubRDGEPdcVjGZCTMGjGJWJubKm2Pe'), true, 'isWif')
