...
/**
  ...
  @param {string} [pubkey_prefix = 'ALA']
*/
function PublicKey(Q, pubkey_prefix = 'ALA') {
    if(typeof Q === 'string') {
     ...
     * @arg {string} [pubkey_prefix = 'ALA'] - public key prefix
    */
    function toString(pubkey_prefix = 'ALA') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'ALA']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'ALA') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'ALA') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'ALA') {
